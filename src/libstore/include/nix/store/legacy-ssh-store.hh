...
public:
    ...
    /**
     * Fetch a build log over the serve protocol (`QueryBuildLog`). Requires the
     * negotiated serve version to support diagnostics (>= 2.9), i.e. the
     * `serve-build-logs` experimental feature on both peers; otherwise the
     * operation is unsupported, as before.
     */
