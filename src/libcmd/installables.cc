...
/**
 * The common implementation of `build2` and `buildWithFailures`: build,
 * and partition the results into the built paths and the failures
 * instead of throwing on the latter.
 */
