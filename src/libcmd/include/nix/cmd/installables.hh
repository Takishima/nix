...
struct Installable
{
    ...
    /**
     * Like `build`, but a failed derivation is returned as its
     * `KeyedBuildResult` instead of throwing. The caller is responsible
     * for still failing the command, see `throwBuildErrors`.
     */
